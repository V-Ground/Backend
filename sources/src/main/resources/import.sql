...
insert into user (id, email, password, username) values('2', 'student1@vground.com', '$2a$10$iadnCLJkh4oZsuWB8lYRLODvMHRfhjuYFCZwr.DjOIQR/SOb/5l9O', '고현수');
insert into user (id, email, password, username) values('3', 'student1@vground.com', '$2a$10$5lD.defa9U3dzwwYK33c0OtwFaccqkcdOh/zkcpQldXpnHTGQCVqG', '김경태');
insert into user (id, email, password, username) values('4', 'student1@vground.com', '$2a$10$Gyk/mLgD2N2y5rHgEC8aVugHJ94.upfS/2gK1tZ7GpaNkzVL3RHx2', '임창현');
insert into user (id, email, password, username) values('5', 'student1@vground.com', '$2a$10$Xx5/an7H13SLrNrKy9A8nO4KHJww2yr1qP46aW29Puv5k/YcrJxhG', '장원익');
